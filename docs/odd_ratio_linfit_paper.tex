...
% Implementation: https://github.com/eartigau/odd_ratio_linfit
% 
...
The method is implemented in the open-source Python package \texttt{odd\_ratio\_linfit},
available at \url{https://github.com/eartigau/odd_ratio_linfit}. The package provides
three main functions:

\begin{itemize}
    \item \texttt{odd\_ratio\_linfit}: Robust linear regression $y = a + bx$
    \item \texttt{odd\_ratio\_mean}: Robust weighted mean
    \item \texttt{odd\_ratio\_polyfit}: Robust polynomial regression
\end{itemize}
...
a, a_err, b, b_err = odd_ratio_linfit(x, y, yerr)
\end{verbatim}
